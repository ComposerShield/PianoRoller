...
private:
    ...
    constexpr void drawClef(Graphics &g, const float width, const float height, const float clefHeight, const char* clefText) const;
    constexpr void drawStaffLines(Graphics& g, const int width, const int lineSpacing) const;
